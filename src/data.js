export default {
  "basics": {
    ...
    "image": "http://0.gravatar.com/avatar/4523ee21ee63e334517eb3ac134121cc?size=400",
  ...
  "work": [
    {
      ...
      "highlights": [
        ...
        "Built the backend for an application that allows retailers with integrated inventories to associate their menus with a canonical product catalog",
    ...
    {
      "name": "OrderUp (acquired by Groupon)",
      "location": "Baltimore, MD",
      ...
      "highlights": [
        ...
        "Built admin systems for order management including an order dashboard and notification system"
      ]
    }
  ],
  "education": [
